...
class UserLeftNavigation extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      ...
      >
        <div class="flex flex-col justify-between flex-1 mt-6">
          <nav>
            <a
              onClick={() => this.handleNavChange("newAppointment")}
            ...
            >
              ...
              <span
                class="mx-4 font-medium text-black"
...
export default withRouter(UserLeftNavigation);
