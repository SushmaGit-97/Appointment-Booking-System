...
public class AppointmentServiceImplementation implements AppointmentService {
	...
	@Autowired
	public AppointmentServiceImplementation(UserDetailsRepository userDetailsRepository,TimeSlotRepository timeSlotRepository,
	...
	@Override
	public Map<String, Object> Userlogin(UserDetails user) {
	...
	@Override
	public Map<String, Object> AppointmentBooking(TimeSlot timeSlot){
		Map<String, Object> resultMap = new HashMap<>();
	...
	//Getting all appointment booking details
	@Override
	...
	@Override
	public Map<String, Object> UserRegistration(UserDetails userDetails) {
